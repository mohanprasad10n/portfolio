        ...
        <div className="profile">
          ...
          <div className="subtitle subtitle-typed">
            <TypeWriterEffect
              ...
              startDelay={2000}
              cursorColor="#78cc6d"
              multiText={["Developer", "Competitive Coder", "Student", "Learner"]}
              multiTextDelay={1000}
              typeSpeed={50}
              multiTextLoop
            />
          ...
          <div className="social">
            ...
            <a
              className="link"
              href="https://leetcode.com/naraga65/"
              rel="noreferrer"
              target="_blank"
              aria-label="leetcode"
             
            >
              <FaLaptopCode data-aos="fade-up"
              data-aos-delay="100"/>
            </a>
          ...
          <div className="links">
            <a
              href="/assets/MohanPrasad_Resume.pdf"
              className="link"
              rel="noreferrer"

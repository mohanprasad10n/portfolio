...
function Contact() {
  ...
  const submitData = async (event) => {
    ...
    if (firstName && lastName && email && address && message) {
      // const res = fetch("https://portfolio-aee99-default-rtdb.firebaseio.com/userDataRecords.json",
      const res = fetch("https://portfolio-39e59-default-rtdb.firebaseio.com/userDetails.json",
        {
          method: "POST",
          headers: {
      ...
      if (res) {
        // sentdetails(email,firstName,lastName,message,address)
        setUserData({
          firstName: "",
          lastName: "",
          email: "",
